...
public class ParkHelp extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		text.setText("O botão em foco permite estacionar o seu carro. Pode arrastar o mapa para indicar a sua localização.");

		text = (TextView)findViewById(R.id.msgtop);
		text.setText("Ajuda - Estacionar");
		
		
		Button button = (Button)findViewById(R.id.next);
		button.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				Intent intent = new Intent(ParkHelp.this, ReportHelp.class);
				intent.setFlags(Intent.FLAG_ACTIVITY_NO_HISTORY);
				ParkHelp.this.startActivity(intent);
				ParkHelp.this.finish();
			}
		});
	}
